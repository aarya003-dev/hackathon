...
export default function ReviewDetail() {
  ...
  if (error && run === null) {
    return (
      <div className="rounded-xl border border-rose-200 bg-rose-50 px-4 py-10 text-center text-sm text-rose-700">
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        {run.summary ? (
          ...
          <p className="mt-2 text-sm text-slate-400">No summary generated.</p>
        ) : (
        ...
        {run.publication && run.publication.status === 'published' && (
          <p className="mt-2 inline-flex items-center gap-1.5 rounded-lg bg-emerald-50 px-2 py-1 text-xs text-emerald-800">
